...
public class populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Ailment diabeticNeuropathy = new Ailment("Diabetic Neuropathy","https://cacvi.org/wp-content/uploads/2021/10/diagram-of-Diabetic-neuropathy.jpg","A type of nerve damage that can occur with diabetes. The condition most often affects the legs and feet. ", "A type of nerve damage that can occur with diabetes.\n" +
        ...
        Ailment pronation = new Ailment("Pronation","https://www.precisionmovement.coach/wp-content/uploads/2019/01/pronation-definition.gif","Pronation is a natural movement of the foot that occurs during foot landing while running or walking. ", "When your foot rolls more than the 15\n" +
        ...
        Ailment bunions = new Ailment("Bunions", "https://www.knowyourdoctor.com.cy/wp-content/uploads/2020/05/BUNIONS-1.jpg","A bony bump that forms on the joint at the base of the big toe. A bunion is formed when the big toe pushes against the next toe. ","A bony bump that forms on the joint at the base of the big toe.\n" +
        ...
        Ailment mortonNeuroma = new Ailment("Morton's Neuroma","https://sportsfootankle.com/wp-content/uploads/2017/12/Mortons-Neuroma.jpg","A thickening of the tissue around a nerve leading to the toes.", "A thickening of the tissue around a nerve leading to the toes.\n" +
