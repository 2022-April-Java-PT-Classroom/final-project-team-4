...
public class populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Treatment orthoticInsoles = new Treatment("Orthotic Insoles", "Custom-made insoles can be ordered through your podiatrist, that are worn onside your regular shoes.", "Helps provide support on the foot where needed. This can also help relieve and prevent back and hip pain, stress on the knee, ankle injuries, and inflammation of the sole of the foot.");
        ...
        Treatment hammertoePads = new Treatment ("Hammertoe Pads", "You can but non-medicated hammertoe pads that fit around the pointy top of the toe joint.", "Helps relieve painful pressure on the hammertoe.");
        ...
        Treatment rest = new Treatment ("Rest", "For some conditions, simply elevating your foot for short periods during the day can help. Reducing activities, such as jogging, aurobic exercise or dancing, which subjects your feet to high impact is recommended.", "Reduces impact on the foot, and can help reduce pain and promotes healing");
        Treatment decompressionSurgery = new Treatment ("Decompression Surgery", "Surgeons can cut nearby structures, such as the ligament that binds together some of the bomes in the front of the foot. This is a last resort, for those who aren't getting relief from the morton's neuroma-related issues through conventional, non-invasive means.", "Relieves pressure on the nerve, which reduces pain.");
